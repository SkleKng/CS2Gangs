...
```
cd existing_repo
git remote add origin https://gitlab.edgegamers.io/source2/cs2/plugins/cs2-gangs.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.edgegamers.io/source2/cs2/plugins/cs2-gangs/-/settings/integrations)
